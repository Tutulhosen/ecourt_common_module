...
class MyprofileController extends Controller
{
    ...
    public function index()
    {
        ...
        elseif(Auth::user()->is_citizen==1)
        {
            ...
            ->select('ecourt_citizens.present_address', 'ecourt_citizens.permanent_address')
            ->first();
            
            return view('myprofile.show', compact('userManagement','page_title', 'officeInfo', 'user_address'));
        }
        else
        {
    ...
    {   
        ...
        elseif(globalUserInfo()->role_id  == 39 && globalUserInfo()->doptor_user_flag == 0 )
        {
            return view('myprofile.edit_certificte_assitent')->with($data);
        }
    ...
    public function imageUpload()
    {
        ...
        $data['page_title']='Profile Image Update';                        
         ...
         if(globalUserInfo()->is_cdap_user  == 1 )
            ...
            elseif(globalUserInfo()->role_id  == 2 || globalUserInfo()->role_id == 1 || globalUserInfo()->role_id  == 8 || globalUserInfo()->role_id  == 25)
            {
                return view('myprofile.edit_profile_image_certificate_assitent')->with($data);
            }
            else
    ...
    public function change_password_lgged_in()
    {
     ...
     public function update_password_logged_in(Request $request)
    {
        //dd($request);
