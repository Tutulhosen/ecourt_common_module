...
class GccSettingController extends Controller
{
    /**
    ...
    public function shortDecision(Request $request)
    {
        ...
        // return $data;
        $data['page_title'] = 'জিসিও এর সংক্ষিপ্ত আদেশ';
        return view('setting.gcc.short_decision')->with($data);
    }
    ...
    public function shortDecisionCreate()
    {
        ...
        // return $data;
        return view('setting.gcc.short_decision_create')->with($data);
    }
    ...
    public function shortDecisionStore(Request $request)
    {
        ...
        $url = getapiManagerBaseUrl() . '/api/gcc/short-decision-create';
        ...
        return redirect()->route('gcc.settings.short-decision')->with('success', 'Short decision data create successfully');
    }
    ...
    public function shortDecisionEdit($id)
    {
        ...
        // return $data;
        return view('setting.gcc.short_decision_edit')->with($data);
    }
    ...
    public function shortDecisionUpdate(Request $request, $id = '')
    {
        ...
        $datas = json_encode($data, true);
        $url = getapiManagerBaseUrl() . '/api/gcc/short-decision-update/' . $id;
        $token = $this->verifySiModuleToken('WEB');
        $method = 'POST';
        $res = makeCurlRequestWithToken_update(
            $url,
        ...
        return redirect()->route('gcc.settings.short-decision')->with('success', 'Short decision data updated successfully');
    }
}
