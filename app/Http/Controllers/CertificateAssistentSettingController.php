...
class CertificateAssistentSettingController extends Controller
{
    ...
    public function shortDecision(Request $request)
    {
        ...
        return view('setting.gcc.certificate_asst.short_decision')->with($data);    
    }
    ...
    public function shortDecisionCreate()
    {
        ...
        // return $data;
        return view('setting.gcc.certificate_asst.short_decision_create')->with($data);
    }
    ...
    public function shortDecisionEdit($id)
    {
        ...
        // return $data;
        return view('setting.gcc.certificate_asst.short_decision_edit')->with($data);
    }
