...
class AppealController extends Controller
{
    ...
    {
        $subcategories = DB::table("gcc_court")->where("district_id",$id)->whereIn('level',[0,1])->pluck("court_name","id");
        return json_encode($subcategories);
    }

    public function EmcDependentCourt($id)
    {
        $subcategories = DB::table("emc_court")->where("district_id",$id)->pluck("court_name","id");
        return json_encode($subcategories);
    }
}
