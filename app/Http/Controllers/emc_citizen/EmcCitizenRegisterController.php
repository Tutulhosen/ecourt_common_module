...
class EmcCitizenRegisterController extends Controller
{
     /**
    ...
    public function store(Request $request)
    {
        ...
        if ($result) {
            ...
            return redirect()
                ->route('citizen.mobile_check', ['user_id' => encrypt($result)])
    ...
    public function citizen_registration_otp_resend($user_id)
    {
        ...
        if ($update_otp) {
            ...
            return redirect()
                ->route('citizen.mobile_check', ['user_id' => encrypt($user->id)])
                ->with('success', 'আপনার প্রদত্ত মোবাইল নম্বরে একটি ওটিপি প্রদান করা হয়েছে।  সেই ওটিপি প্রদান করে আপনার মোবাইল নম্বর যাচাই করুন। ');
        }
    }
