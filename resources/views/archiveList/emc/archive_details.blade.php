    ...
    <div class="row">
               ...
               <tbody>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td >{{ $all_dis_div_upa->div_name}}</td>
                 </tr>

                 <tr>
                    <th scope="row">জেলা</th>
                    <td >{{ $all_dis_div_upa->dis_name}}</td>
                 </tr>

                 <tr>
                    <th scope="row">উপজেলা/ থানা</th>
                    <td >{{ $all_dis_div_upa->upa_name}}</td>
                 </tr>
      ...
      <div class="col-md-6">
        <table class="table table-striped border">
           ...
           <tr >
              <th scope="row">মামলার রায়</th>
              <td>{{ $case_details->caseJudgmentNote }}</td>
           </tr>
            <tr>
                <th scope="row"> আদালত</th>
                <td >@php
                    if (isset($case_details->court_id)) {
                        echo DB::table('emc_court')
             ...
             @if (!empty($case_details->order_attached_file))
                <tr>
                    ...
                    <td >
                        <a href="{{ $url.'/archive_attached_file/'.$case_details->order_attached_file}}" target="_blank" class="btn btn-sm btn-success font-size-h5 float-left">
                ...
                <tr>
                    ...
                    <td >
                        <a href="{{route('emc.generate.pdf', encrypt($case_details->id))}}" target="_blank" class="btn btn-sm btn-success font-size-h5 float-left">
                            <i class="fa fas fa-file-pdf"></i>
                            <b>দেখুন</b>
