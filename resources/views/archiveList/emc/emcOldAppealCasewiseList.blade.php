        ...
        <div class="col-md-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <div class="card-body overflow-auto">
                    ...
                    <form class="form-inline" method="POST" action="{{route('emc.old_closed_list.search')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 ">
                                <button type="submit" class="btn btn-primary font-weight-bolder mb-2 ml-2" id="search_btn">অনুসন্ধান করুন</button>
                            </div>
                        </div>
                        </div>
                        ...
                        <tbody>
                            ...
                            {{-- @dd($row); --}}
                                <tr>
                                    ...
                                    <td>{{ $row->applicantName . 'vs' . $row->defaulterName }}</td>
                                    {{-- -<td>{{ $row->org_name }}</td>- --}}
                                    {{-- <td>{{ $row->court_id }}</td> --}}
                                    <td>
                                    {{$row->court_name}}
                                        ...
                                        <div class="btn-group float-right">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item"
                                                    href=" {{ route('emc.showAppealViewPage', encrypt($row->id)) }} ">বিস্তারিত
                                                    তথ্য</a>
