...
<div class="card card-custom" style="margin-bottom: 20px;">
   <div class="card-header flex-wrap py-5">
      ...
      <div class="card-toolbar">        
         <a href="{{ route('gcc.court.create') }}" class="btn btn-sm btn-success font-weight-bolder">
   ...
   <div class="card-body">
      ...
      @if($roleID == 1 || $roleID == 2 || $roleID == 3 || $roleID == 4)
         @include('gcc_court.court.search')
      @endif
      <table class="table table-hover mb-6 font-size-h6">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td><?=$courtStatus?></td>
               <td>
                  <a href="{{ route('gcc.court.edit', $row->id) }}" class="btn btn-success btn-shadow btn-sm font-weight-bold pt-1 pb-1">সংশোধন</a>
               </td>
            </tr>
            @endforeach
         </tbody>
...
<script type="text/javascript">
      jQuery(document).ready(function ()
      {
         ...
         jQuery('select[name="district"]').on('change',function(){
            ...
            {
               jQuery.ajax({
                  url : '/gcc/court-setting/dropdownlist/getDependentUpazila/' +dataID,
                  type : "GET",
                  dataType : "json",
                  success:function(data)
                  {
