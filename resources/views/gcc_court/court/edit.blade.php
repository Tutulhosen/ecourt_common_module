    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                @endif
                <!--begin::Form-->
                <form action="{{ route('gcc.court.update', $courts->id) }}" class="form" method="POST">
                    @csrf
                    <div class="card-body">
                                ...
                                <select name="division" id="division_id" class="form-control form-control-sm">
                                    ...
                                    @foreach ($division as $value)
                                        <option value="{{ $value->id }}"
                                            {{ $value->id == $courts->division_id ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-3 mb-5">
                                ...
                                <select name="district" id="district_id" class="form-control form-control-sm">
                                    ...
                                    @foreach ($districts as $value)
                                        <option value="{{ $value->id }}"
                                            {{ $value->id == $courts->district_id ? 'selected' : '' }}>
                                            {{ $value->district_name_bn }} </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="court_name" class=" form-control-label">আদালতের নাম <span
                                        class="text-danger">*</span></label>
                                <input type="text" id="court_name" name="court_name" placeholder="আদালতের নাম লিখুন"
                                    class="form-control form-control-sm" value="{{ $courts->court_name }}">
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            ...
            jQuery('select[name="division"]').on('change', function() {
                ...
                if (dataID) {
                    jQuery.ajax({
                        url: '/gcc/court-setting/dropdownlist/getdependentdistrict/' + dataID,
                        type: "GET",
                        dataType: "json",
