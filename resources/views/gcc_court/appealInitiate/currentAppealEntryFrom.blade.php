                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                           <div class="col-lg-3 mb-5">
                                               <div class="form-group">
                                                    <label class="control-label">উপজেলা নির্বাচন করুন <span class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="applicantName_1" class="control-label">
                                                        ...
                                                        <!-- <select class="form-control" aria-label=".form-select-lg example" name="applicant[name][0]" id="applicant_name" required>
                                                            <option value=" ">আবেদনকারীর নির্বাচন করুন </option>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="applicantFather_1" class="control-label">
                                                        <!-- <span style="color:#FF0000">* </span> -->
                                                            আবেদনকারীর প্রতিষ্ঠানে আবেদনকারীর EmployeeID</label>
                                ...
                                <fieldset class="pb-5" data-wizard-type="step-content">
                                    ...
                                    <div id="template" >
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="order_file_type[]" class="form-control form-control-sm"  id="file_name_order_templateFile_4" value="৭৭ ধারার কারন দর্শানোর নোটিশ" placeholder="৭৭ ধারার কারন দর্শানোর নোটিশ">
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="input-group">
...
jQuery('#applicantTypeBank').on('change',function(){
    ...
    //jQuery('#office_id').on('change',function(){
        ...
        //     url: '{{ url('appeal/getdependentOfficeName/') }}/'+dataID,
        //     type: "GET",
        //     dataType: "json",
        //     success: function(data) {
