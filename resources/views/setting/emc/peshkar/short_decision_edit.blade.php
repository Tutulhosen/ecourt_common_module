...
@section('content')
    <!--begin::Card-->
    <div class="card card-custom col-12" style="margin-bottom: 20px;">
        ...
        <form action="{{ route('peshkar.short.decision.update', $shortDecision->id) }}" method="POST">
            @csrf
                                  ...
                                  <tr>
                                     <td>
                                        <div class="checkbox-inline">
                                            ...
                                            @php
                                                $law_sec = DB::table('peshkar_case_shortdecisions')->select('law_sec_id')->where('peshkar_case_shortdecisions.id', $shortDecision->id)->first()->law_sec_id;
