    ...
    <div class="card card-custom" style="margin-bottom: 20px;">
        <div class="card-header flex-wrap py-5">
            ...
            <div class="card-toolbar">
                <a href="{{ route('emc.short-decision.create') }}" class="btn btn-sm btn-success font-weight-bolder">
                    <i class="la la-plus"></i>নতুন এক্সিকিউটিভ ম্যাজিস্ট্রেট এর আদেশ তৈরি
                </a>
            </div>
        </div>
        ...
        <div class="card-body">
                ...
                <div class="container">
                   <div class="row">
                      <div class="col-lg-3 mb-5">
                         <input type="text" name="search_short_order_name" class="w-100 form-control common_datepicker" placeholder="এক্সিকিউটিভ ম্যাজিস্ট্রেট এর আদেশ" autocomplete="off">
                      </div>
            ...
            <table class="table table-hover mb-6 font-size-h6">
                <thead class="thead-success" style="background-color: #008841; color:white">
                    <tr>
                        <th scope="col" width="30">#</th>
                        <th scope="col">এক্সিকিউটিভ ম্যাজিস্ট্রেট এর আদেশ</th>
                ...
                <tbody>
                    ...
                    @foreach ($shortDecision as $key => $row)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('emc.short-decision.details_create', $row->id) }}"
                                    class="btn btn-primary btn-shadow btn-sm font-weight-bold pt-1 pb-1">টেমপ্লেট
                                </a>
                                <a href="{{ route('emc.short-decision.edit', $row->id) }}"
