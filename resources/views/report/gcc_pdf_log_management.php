        ...
        <div class="priview-header">
            <div class="row">
                ...
                <div class="col-6 text-center float-left" style="border: 0px solid red;">
                    ...
                    <!-- <div style="font-size:18px;"><u><?= $data->page_title ?></u></div> -->
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <?php 
                        ...
                        if (isset($data->lawerCitizen[0]['citizen_name']) > 0)
                        {
                            ?>
                    ...
                    <table class="table">
                        ...
                        <?php $k = 1; 
                                foreach ($data->lawerCitizen as $nominee)
                                {
                                     ?>
                        <tr>
                            <td><?= en2bn($k) ?>.</td>
                ...
                <div class="col-md-7">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><?= $data->defaulterCitizen->organization ?? '-' ?></td>
                        </tr>
                        <?php  $k++; ?>
                    </table>

                    <?php if (isset($data->nomineeCitizen[0]['citizen_name']) > 0)
                    {
                        ?>
                    <h5><span class="font-weight-bolder">উত্তরাধিকারের বিবরণ:</span></h5>
                    <table class="table">
                        ...
                        <?php $k = 1; ?>
                        <?php foreach ($data->nomineeCitizen as $nominee)
                            {
                                 ?>
                        <tr>
                            <td><?= en2bn($k) ?>.</td>
