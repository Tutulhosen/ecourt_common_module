                    ...
                    <table class="table table-striped border">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?= $data->guarantorCitizen->citizen_name ?? '-' ?></td>
                                <td><?= $data->guarantorCitizen->father ?? '-' ?></td>
                                <td><?= $data->guarantorCitizen->organization ?? '-' ?></td>
                            </tr>
                    ...
                    <table class="table table-striped border">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?= $data->lawerCitizen->organization ?? '-' ?></td>
                            </tr>
