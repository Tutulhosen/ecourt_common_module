            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <span
                            class="text-dark flex-root font-weight-bolder font-size-h6">{{ $userManagement->mobile }}</span>
                    </div>
                    <div class="d-flex mb-3">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <span
                            class="text-dark flex-root font-weight-bolder font-size-h6">{{ $userManagement->father_name }}</span>
                    </div>
                    <div class="d-flex mb-3">
                        <span class="text-dark-100 flex-root font-weight-bold font-size-h6">মাতার নামঃ</span>
                        <span
                            class="text-dark flex-root font-weight-bolder font-size-h6">{{ $userManagement->mother_name }}</span>
                    </div>

                    <div class="d-flex mb-3">
                        <span class="text-dark-100 flex-root font-weight-bold font-size-h6">লিঙ্গঃ</span>
                        <span
                            class="text-dark flex-root font-weight-bolder font-size-h6">{{ $userManagement->gender === 'Male' ? 'পুরুষ' : 'মহিলা' }}</span>
                    </div>
                    <div class="d-flex mb-3">
                        ...
                        <span class="text-dark flex-root font-weight-bolder font-size-h6">
                            @if ($profile_pic != null)
                                <img class="img-fluid" src="{{ url('/') }}/uploads/profile/{{ $profile_pic }}"
