...
@section('content')
    ...
    <form class="" method="POST" action="{{ route('mc.section.update', $section->id) }}">
        @csrf
                            ...
                            <select name="law_id" id="lawSelect" class="form-control law_type">
                                ...
                                @foreach ($laws as $law)
                                    <option data-details="{{ $law->title }}" value="{{ $law->id }}"
                                        {{ $law->id == $section->law_id ? 'selected' : '' }}>
                                        {{ $law->title }}</option>
                                @endforeach
                            </select>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <div class="form-group">
                            ...
                            <textarea name="sec_description" id="" style="width: 100%" rows="5">{{ $section->sec_description }}</textarea>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input name="sec_number" placeholder="শুধুমাত্র সংখ্যাটি লিখুন "
                                style="width: 100%; height: 40px" type="text" value="{{ $section->sec_number }}">
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <div class="form-group">
                            ...
                            <textarea name="punishment_des" id="" style="width: 100%" rows="5">{{ $section->punishment_des }}</textarea>
                        </div>
                        <!-- form-group -->
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input name="punishment_sec_number" placeholder="শুধুমাত্র সংখ্যাটি লিখুন "
                                ...
                                value="{{ $section->punishment_sec_number }}">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input name="max_fine" style="width: 40%; height: 40px" type="text" value="{{$section->max_fine}}">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input name="min_fine" style="width: 40%; height: 40px" type="text" value="{{$section->min_fine}}">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label style="background: #008841; color: white; width:100%" class="control-label"><span
                                ...
                                জেল</label>
                            <input name="next_jail" style="width: 40%; height: 40px" type="text" value="{{$section->next_jail}}">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label style="background: #008841; color: white; width:100%" class="control-label"><span
                                    style="color:#FF0000"></span> পুনরায় অপরাধের শাস্তি
                                -জরিমানা</label>
                            <input name="next_fine" style="width: 40%; height: 40px" type="text" value="{{$section->next_fine}}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="punishment_type" id="" class="form-control court_type">
                                ...
                                @foreach ($punishment_type as $type)
                                    <option value="{{ $type->id }}" {{ $type->id == $section->punishment_type ? 'selected' : '' }}>{{ $type->description }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea name="extra_punishment" id="" style="width: 100%" rows="6">{{$section->extra_punishment}}</textarea>
