...
<div id="printdivemcasereportWithComment" class="content_form_potrait">

    <div class="form_top_title">
        <table style="width: 100%">
            <tr>
                <td colspan="3" class="centertext"><span id="cmt_div_em_allmonthreg_name">allmonthreg_name</span></td>
            </tr>
            <tr>
                <td colspan="3" class="centertext"><span id="cmt_div_em_month_year">month_year</span></td>
            </tr>
        </table>
    </div>


    <table id='cmt_div_em_monthlyregister_table' border="1" style="border-collapse:collapse;" cellpadding="2px"
           cellspacing="2px" width="100%">
        <tr>
            <td class="centertext" style="width: 10%" ROWSPAN=2>বিভাগের নাম</td>
            <td class="centertext" style="width: 36%;" colspan="3">পূর্বের মাস (<span id="cmt_div_em_pre_month_year2">pre_month_year</span>)
            </td>
            <td class="centertext" style="width: 36%;" colspan="3">বিবেচ্য মাস (<span
                        id="cmt_div_em_month_year2">month_year</span>)
            </td>
...
<script>
    function pdivemc_setParamsWithComment(data) {

        document.getElementById("cmt_div_em_allmonthreg_name").innerHTML = data.name;
        document.getElementById("cmt_div_em_month_year").innerHTML = data.month_year;
        document.getElementById("cmt_div_em_month_year2").innerHTML = data.month_year;
        document.getElementById("cmt_div_em_pre_month_year2").innerHTML = data.pre_month_year;


        var myTable = document.getElementById("cmt_div_em_monthlyregister_table");
        ...
        $(data.result).each(function (index, element) {
            ...
            if (divname == element['divname']) {
                $('#cmt_div_em_monthlyregister_table').append(
                        '<tr>' +
                                '<td> ' + totaltext + '</td>' +
