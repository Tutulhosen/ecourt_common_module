...
<div id="printdivmobilecourtreportWithComment" class="content_form_potrait">
    
    <div class="form_top_title">
        <table style="width: 100%">
            <tr>
                <td colspan="3" class="centertext"><span
                            id="cmt_div_mobile_allmonthreg_name">allmonthreg_name</span></td>
            </tr>
            <tr>
                
                <td colspan="3" class="centertext"><span id="cmt_div_mobile_month_year">month_year</span></td>
            </tr>
        </table>
    </div>


    <table id='cmt_div_mobile_monthlyregister_table' border="1" style="border-collapse:collapse;" cellpadding="2px"
...
<script>
    function pdivmc_setParamsWithComment(data) {

        document.getElementById("cmt_div_mobile_allmonthreg_name").innerHTML = data.name;
        document.getElementById("cmt_div_mobile_month_year").innerHTML = data.month_year;


        var myTable = document.getElementById("cmt_div_mobile_monthlyregister_table");
...
//           alert(JSON.stringify(element));
            ...
            if (divname == element['divname']) {
                totaltext = 'সর্বমোট';
                $('#cmt_div_mobile_monthlyregister_table').append(
                        '<tr>' +
