...
<style>
    ...
    @endif
    <form action="{{ route('mc_sottogolpo.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <select name="law_id" class="form-control" {{--  onchange="showZilla(this.value,'zilla')" --}}>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <select name="case_type_id" class="form-control" {{--  onchange="showZilla(this.value,'zilla')" --}}>
                                <option value="">বাছাই করুন...</option>
