                ...
                <div class="card card-custom">
                    ...
                    <div class="card-title">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            @if (!empty($investigate_data->victimCitizen))
                                <li class="nav-item">
                            ...
                            @if (isset($investigate_data->lawerCitizen->citizen_name) > 0)
                                <li class="nav-item">
                            ...
                            @if (!empty($investigate_data->defaulerWithnessCitizen))
                                <li class="nav-item">
                            ...
                            @endif
                            @if (isset($investigate_data->defaulerLawyerCitizen[0]->citizen_name))
                                <li class="nav-item">
                        ...
                        <div class="tab-content mt-5" id="myTabContent">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div name="caseNo" id="caseNo" class="form-control form-control-sm">
                                                    ...
                                                    {{ $investigate_data->appeal->case_no }}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input
                                                    value="{{ date('d-m-Y', strtotime($investigate_data->appeal->case_date)) ?? '' }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="lawSection" id="lawSection"
                                                    ...
                                                    value="{{ $investigate_data->law_section_info->crpc_name ?? '' }}">
                                            </div>
                                        </div>
                                        {{-- @dd($investigate_data->appeal) --}}
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="division" id="division_id"
                                                    ...
                                                    <option>{{ $investigate_data->division_info->division_name_bn ?? '' }}
                                                    </option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="district" id="district_id"
                                                    class="form-control form-control-sm">
                                                    <option>
                                                        {{ $investigate_data->appeal->district->district_name_bn ?? '' }}
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="upazila" id="upazila_id"
                                                    class="form-control form-control-sm">
                                                    <option>{{ $investigate_data->appeal->upazila->upazila_name_bn ?? '' }}
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 mb-5">
                                            <div class="form-group">
                                                ...
                                                <div class="border p-5" style="height: 200px; overflow-y: scroll;">
                                                    ...
                                                    {!! $investigate_data->law_section_info->crpc_details ?? '' !!}
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="applicant" role="tabpanel" aria-labelledby="applicant-tab">
                                <section class="panel panel-primary applicantInfo" id="applicantInfo">
                                    <div class="accordion accordion-solid accordion-toggle-plus" id="accordionExample3">
                                        @forelse ($investigate_data->applicantCitizen as $key => $item)
                                            @php
                                                $count = ++$key;
                                            @endphp
                                            <div class="clearfix">
                            ...
                            <div class="tab-pane fade" id="victim" role="tabpanel" aria-labelledby="victim-tab">
                                <section class="panel panel-primary victimInfo" id="victimInfo">
                                    <div class="accordion accordion-solid accordion-toggle-plus" id="accordionExample3">
                                        @forelse ($investigate_data->victimCitizen as $key => $item)
                                            @php
                                                $count = ++$key;
                                            @endphp
                                            <div class="clearfix">
                            ...
                            <div class="tab-pane fade" id="deafulter" role="tabpanel" aria-labelledby="deafulter-tab">
                                <section class="panel panel-primary deafulterInfo" id="deafulterInfo">
                                    <div class="accordion accordion-solid accordion-toggle-plus" id="accordionExample3">
                                        @forelse ($investigate_data->defaulterCitizen as $key => $item)
                                            @php
                                                $count = ++$key;
                                            @endphp
                            ...
                            <div class="tab-pane fade" id="witness" role="tabpanel" aria-labelledby="witness-tab">
                                ...
                                <div class="accordion accordion-solid accordion-toggle-plus" id="accordionExample3">
                                    @forelse ($investigate_data->witnessCitizen as $key => $item)
                                        @php
                                            $count = ++$key;
                                        @endphp
                                        <div id="cloneNomenee" class="card">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="lawyer[name]" id="lawyerName_1"
                                                                class="form-control form-control-sm"
                                                                value="{{ $investigate_data->lawerCitizen->citizen_name }}">
                                                            ...
                                                            <input type="hidden" name="lawyer[id]" id="lawyerId_1"
                                                                class="form-control form-control-sm"
                                                                value="{{ $investigate_data->lawerCitizen->id }}">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="lawyer[phn]" id="lawyerPhn_1"
                                                                class="form-control form-control-sm"
                                                                value="{{ $investigate_data->lawerCitizen->citizen_phone_no }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="lawyer[nid]" id="lawyerNid_1"
                                                                class="form-control form-control-sm"
                                                                value="{{ $investigate_data->lawerCitizen->citizen_NID }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select style="width: 100%;"
                                                                ...
                                                                <option value="">বাছাই করুন</option>
                                                                <option value="MALE"
                                                                    {{ $investigate_data->lawerCitizen->citizen_gender == 'MALE' ? 'selected' : '' }}>
                                                                    পুরুষ</option>
                                                                <option value="FEMALE"
                                                                    {{ $investigate_data->lawerCitizen->citizen_gender == 'FEMALE' ? 'selected' : '' }}>
                                                                    নারী</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="lawyer[father]" id="lawyerFather_1"
                                                                class="form-control form-control-sm"
                                                                value="{{ $investigate_data->lawerCitizen->father }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="lawyer[mother]" id="lawyerMother_1"
                                                                class="form-control form-control-sm"
                                                                value="{{ $investigate_data->lawerCitizen->mother }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="lawyer[designation]" id="lawyerDesignation_1"
                                                                class="form-control form-control-sm"
                                                                value="{{ $investigate_data->lawerCitizen->designation }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="lawyer[organization]" id="lawyerOrganization_1"
                                                                class="form-control form-control-sm"
                                                                value="{{ $investigate_data->lawerCitizen->organization }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="lawyerPresentAddree_1" name="lawyer[presentAddress]" rows="5"
                                                                class="form-control element-block blank" aria-describedby="note-error" aria-invalid="false">{{ $investigate_data->lawerCitizen->present_address ?? '-' }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" name="lawyer[email]" id="lawyerEmail_1"
                                                                class="form-control form-control-sm"
                                                                value="{{ $investigate_data->lawerCitizen->email ?? '-' }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            @if (!empty($investigate_data->defaulerWithnessCitizen))
                                <div class="tab-pane fade" id="defaulerWithnessCitizen" role="tabpanel"
                                    ...
                                    <div class="accordion accordion-solid accordion-toggle-plus" id="accordionExample3">
                                        @forelse ($investigate_data->defaulerWithnessCitizen as $key => $item)
                                            @php
                                                $count = ++$key;
                                            @endphp
                                            <div id="cloneNomenee" class="card">
                            ...
                            @endif
                            @if (isset($investigate_data->defaulerLawyerCitizen[0]->citizen_name))
                                <div class="tab-pane fade" id="defaulerLawyerCitizen" role="tabpanel"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="lawyer[name]" id="lawyerName_1"
                                                                class="form-control form-control-sm"
                                                                value="{{ $investigate_data->defaulerLawyerCitizen[0]->citizen_name }}">
                                                            <input type="hidden" name="lawyer[type]"
                                                                class="form-control form-control-sm" value="4">
                                                            <input type="hidden" name="lawyer[id]" id="lawyerId_1"
                                                                class="form-control form-control-sm"
                                                                value="{{ $investigate_data->defaulerLawyerCitizen[0]->id }}">
                                                            <input type="hidden" name="lawyer[email]" id="lawyerEmail_1"
                                                                class="form-control form-control-sm" value="">
                                                            <input type="hidden" name="lawyer[thana]" id="lawyerThana_1"
                                                                class="form-control form-control-sm" value="">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="lawyer[phn]" id="lawyerPhn_1"
                                                                class="form-control form-control-sm"
                                                                value="{{ $investigate_data->defaulerLawyerCitizen[0]->citizen_phone_no }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="lawyer[nid]" id="lawyerNid_1"
                                                                class="form-control form-control-sm"
                                                                value="{{ $investigate_data->defaulerLawyerCitizen[0]->citizen_NID }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select style="width: 100%;"
                                                                ...
                                                                <option value="">বাছাই করুন</option>
                                                                <option value="MALE"
                                                                    {{ $investigate_data->defaulerLawyerCitizen[0]->citizen_gender == 'MALE' ? 'selected' : '' }}>
                                                                    পুরুষ</option>
                                                                <option value="FEMALE"
                                                                    {{ $investigate_data->defaulerLawyerCitizen[0]->citizen_gender == 'FEMALE' ? 'selected' : '' }}>
                                                                    নারী</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="lawyer[father]" id="lawyerFather_1"
                                                                class="form-control form-control-sm"
                                                                value="{{ $investigate_data->defaulerLawyerCitizen[0]->father }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="lawyer[mother]" id="lawyerMother_1"
                                                                class="form-control form-control-sm"
                                                                value="{{ $investigate_data->defaulerLawyerCitizen[0]->mother }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="lawyer[designation]" id="lawyerDesignation_1"
                                                                class="form-control form-control-sm"
                                                                value="{{ $investigate_data->defaulerLawyerCitizen[0]->designation }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="lawyer[organization]" id="lawyerOrganization_1"
                                                                class="form-control form-control-sm"
                                                                value="{{ $investigate_data->defaulerLawyerCitizen[0]->organization }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="lawyerPresentAddree_1" name="lawyer[presentAddress]" rows="5"
                                                                class="form-control element-block blank" aria-describedby="note-error" aria-invalid="false">{{ $investigate_data->defaulerLawyerCitizen[0]->present_address ?? '-' }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                    ...
                                    <form method="post" action="{{ route('investigator.form.submit') }}"
                                        ...
                                        <div class="mb-2 pb-2">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="inputPassword"
                                                        name="case_no" value="{{ $case_no }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-2 pb-2">
                                            ...
                                            <div class="mb-3 row">
                                                <label for="inputPassword" class="col-sm-2 col-form-label">স্মারক নং
                                                    <span style="color: red">*</span></label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="inputPassword"
                                                        name="memorial_no">
                                                ...
                                                <div class="col-md-12 mb-5">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group" id="step1Content">
                                                            <label>তদন্ত সংযুক্তি (মূল প্রতিবেদন) <span
                                                                    style="color: red">
                                                                    ***
                                                                </span> </label>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <input type="text"
                                                                        class="form-control form-control-sm"
                                                                        placeholder="ফাইলের নাম দিন" id="" name="todonto_attached"
