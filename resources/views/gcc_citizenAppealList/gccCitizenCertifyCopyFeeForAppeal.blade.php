            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <div class="wizard wizard-1" id="appealWizard" data-wizard-state="step-first" data-wizard-clickable="true">
                    <div class="card" style="width: 50%; margin:auto; text-align:center; font-weight:bold; color:red">
                        <div class="card-body">
                            <h3 >সার্টিফাইড কপির জন্য আপনাকে ফোলিও সংখ্যার উপর ফি প্রদান করতে হবে । </h3>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center mt-5 mb-10 px-8 mb-lg-15 px-lg-10">
                        <div class="col-xl-12 col-xxl-7">
                            <!--begin::Form Wizard-->
                            <form id="appealCase" action="{{route('gcc.citizen.certify.copy.fee.submit')}}" class="form" method="POST"
                                ...
                                <fieldset class="pb-5 create_cause" data-wizard-type="step-content"
                                    ...
                                    <div class="form-group">
                                        <label for="total_page" class="control-label"><span
                                                style="color:#FF0000">*
                                            </span>মোট ফোলিও সংখ্যা</label>
                                        <div class="input-group">
                                            <input type="text" name="total_page" id="total_page"
                                                class="form-control form-control-sm " value="{{$total_page}}" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="court_fee_amount" id="court_fee_amount"
                                                class="form-control form-control-sm " value="{{$cost_total}}" required>
                                        
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="payment_recept" class="control-label"><span
                                                style="color:#FF0000">*
                                            </span>সংযুক্তি (পেমেন্ট রশিদ)</label><br>
                                        <input type="file" id="payment_recept" name="payment_recept" required>
                                    ...
                                    <button type="submit"
                                    class="btn btn-success font-weight-bolder text-uppercase px-9 py-4"> প্রেরণ করুন</button>
                            </form>
                            <!--end::Form Wizard-->
                        </div>
                    </div>
