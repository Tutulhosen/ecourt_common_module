    ...
    <div class="card" style="margin-bottom: 20px">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label">
                    জেনারেল সার্টিফিকেট আদালতে মামলা কার্যকলাপ নিরীক্ষা
                </h3>
            </div>
        </div>
        <div class="card-body">
            ...
            @endphp
            <form class="form-inline" method="GET" action="{{ route('gcc.log_index') }}">
                @csrf
                ...
                <tbody>
                    ...
                    @foreach ($cases as $row)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('gcc.log_index_single', ['id' => encrypt($row->id)]) }}"
