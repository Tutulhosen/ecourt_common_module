...
@section('content')
    ...
    <div class="card" style="margin-bottom: 20px">
        <div class="card-header" style="font-size: 20px">
            ইউজারের তথ্য (জেনারেল সার্টিফিকেট কোর্ট)
        </div>
        <div class="card-body">

            <fieldset class="mb-6">
                <legend style="color: white; font-size: 16px">ফিল্টারিং ফিল্ড সমূহ</legend>
                <form action="{{ route('gcc.user.list.search') }}" method="get">
            ...
            <table class="table table-hover mb-6 font-size-h5">
                ...
                <tbody>
                    @if (!empty($all_gcc_user))
                        @php
                        $i = 0;
                        @endphp
                        @foreach ($all_gcc_user as $row)
                            <tr style="padding:0%" style="display: flex;  justify-content: space-between">
                                ...
                                <td class="">{{ GccRoleName($row->role_id) }}</td>
            ...
            <div class="d-flex justify-content-center pt-5">
                <ul class="pagination">
                    ...
                    {!! $all_gcc_user->links('pagination::bootstrap-4') !!}
