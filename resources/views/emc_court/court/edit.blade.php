        ...
        <div class="card card-custom gutter-b example example-compact">
            <div class="card-header">
            	...
            	@if ($errors->any())
 				...
 				@endif
            <!--begin::Form-->
            <form action="{{ route('emc.court.update' , $courts->id) }}" class="form" method="POST">
            @csrf
                <div class="card-body">
                    <div class="form-group row">
    		             	...
    		             	<div class="col-lg-3">
    		                  <label>লেভেল</label>
    							<div class="radio-inline">
    								<label class="radio">
    								<input type="radio" name="level" value="1"   {{ ($courts->level =="1")? "checked" : "" }}/>
    								<span></span>জেলা</label>
    								<label class="radio">
    								<input type="radio" name="level" value="0"   {{ ($courts->level =="0")? "checked" : "" }}/>
    								<span></span>উপজেলা</label>
    							</div>
    	                	</div>
                            ...
                            <div class="col-lg-3">
                              <label>স্ট্যাটাস</label>
                                <div class="radio-inline">
                                    <label class="radio">
                                    <input type="radio" name="status" value="1" {{ ($courts->status =="1")? "checked" : "" }} />
                                    <span></span>এনাবল</label>
                                    <label class="radio">
                                    <input type="radio" name="status" value="0" {{ ($courts->status =="0")? "checked" : "" }} />
...
<script type="text/javascript">
        jQuery(document).ready(function ()
        {
            ...
            jQuery('select[name="division"]').on('change',function(){
                ...
                {
                  jQuery.ajax({
                    url : '/emc/court-setting/dropdownlist/getdependentdistrict/' +dataID,
                    type : "GET",
                    dataType : "json",
