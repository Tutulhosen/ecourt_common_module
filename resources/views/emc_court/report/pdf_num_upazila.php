		...
		<div class="priview-header">
			<div class="row">
				...
				<div class="col-6 text-center float-left">
					...
					<div style="font-size:16px;"><u><?= $report_name ?> বিভিন্ন আদালতের মামলা সংক্রান্ত তথ্য</u></div>
		...
		<div class="priview-memorandum">
			<div class="row">
				<div class="col-6 text-left float-left">
					বিভাগের নাম: <strong><?=$div_data?></strong> <br/>
					জেলার নাম: <strong> <?=$dis_data?></strong>
				</div>
			</div>
		</div>
		...
		<div class="priview-demand">
			<table class="table table-hover table-bordered report">
				<thead class="headding">
					...
					<tr>
						<!-- <th class="text-center" rowspan="11">মোট মামলা</th> -->
						<th class="text-center" width="50">ক্রম</th>
						<th class="text-center">উপজেলার নাম</th>
						<th class="text-center">এক্সিকিউটিভ ম্যাজিস্ট্রেটের আদালতে বিচারাধীন </th>
						<th class="text-center">অতিরিক্ত জেলা ম্যাজিস্ট্রেটের আদালতে বিচারাধীন </th>
						<th class="text-center">গ্রহণের জন্য অপেক্ষমান (ইএম কোর্ট)</th>
						<th class="text-center">গ্রহণের জন্য অপেক্ষমান (এডিএম কোর্ট)</th>
						<th class="text-center">নিষ্পত্তিকৃত মামলা</th>
						<th class="text-center">মোট মামলা</th>
					</tr>
				</thead>
				<tbody>
					<?php
					$i = $grandTotal = 0;
					$totals = array_fill(2, 7, 0);
					// print_r($totals);
					foreach ($results as $row) {
						...
						$totals[2] += $on_trial_em;
						$totals[3] += $on_trial_dm;
						$totals[4] += $send_to_em;
						$totals[5] += $send_to_adm;
						$totals[6] += $colsed;
						$totals[7] += $grandTotal;
						// dd($row);
					...
					<?php } ?>
					<tr>
						<td colspan="2" class="text-center"><strong>সর্বমোট</strong></td>
						<?php for ($j = 2; $j <= 7; $j++) : ?>
							<th class="text-center"><?= en2bn($totals[$j]) ?></th>
						<?php endfor; ?>
					</tr>
				</tbody>
			</table>
