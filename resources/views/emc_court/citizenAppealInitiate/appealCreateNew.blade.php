                ...
                <div class="wizard wizard-1" id="appealWizard" data-wizard-state="step-first" data-wizard-clickable="true">
                    ...
                    <div class="row justify-content-center mt-5 mb-10 px-8 mb-lg-15 px-lg-10">
                        <div class="col-xl-12 col-xxl-12">
                            <!--begin::Form Wizard-->
                            <form id="appealCase" action="{{ route('emc.citizen.appeal.store') }}" class="form"
                                method="POST" enctype="multipart/form-data">
                                @csrf

                                <input type="hidden" id="citizen_appeal_check"
                                    value="{{ route('emc.citizen.appeal.nid.check') }}">
                                ...
                                <fieldset class="pb-5 create_cause" data-wizard-type="step-content"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-5">
                                            ...
                                            @include('emc_court.appealTrial.inc._voice_to_text')
                                        </div>
                                    </div>
                                ...
                                <!--begin::Step 2-->
                                @include('emc_court.citizenAppealInitiate.inc._applicant_info')
                                <!--end::Step 2-->

                                <!--begin::Step 3 victim-->
                                @include('emc_court.citizenAppealInitiate.inc._victim_info')
                                <!--end::Step 3 victim-->

                                <!--begin::Step 4-->
                                @include('emc_court.citizenAppealInitiate.inc._defaulter_info')
                                <!--end::Step 4-->

                                <!--begin::Step 5-->
                                @include('emc_court.citizenAppealInitiate.inc._witness_info')
                                <!--end::Step 5-->

                                <!--begin::Step 6-->
                                @include('emc_court.citizenAppealInitiate.inc._advocate_info')
                                <!--end::Step 6-->
...
@section('scripts')
    ...
    @include('emc_court.citizenAppealInitiate.appealCreate_Js')
    <script src="{{ asset('js/initiate/iappealCreate_Jsnit.js') }}"></script>
    ...
    <script src="{{ asset('js/appeal/emc/appealCreateValidate.js') }}"></script>
    <script>
