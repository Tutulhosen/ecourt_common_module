            ...
            <div class="row" id="element-to-print">
                    ...
                    <table class="tg">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="tg-wo29">{{ $appeal['office_name'] }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-wo29">{{ $appeal['office_unit_name'] }}</td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="col-md-8 mx-auto" style="margin-top: 20px; text-align:center">
                    ...
                    <table class="tg2">
                        ...
                        <tbody>
                            @forelse ($shortOrderTemplateList as $key => $note)
                                @php
                                    $trialDate = date('Y-m-d',strtotime($note['conduct_date']));
                                @endphp
                                <tr>
                                    <td class="tg-wo29">{{ en2bn($key+1) }} -
                                        নম্বর :</td>
                                    <td class="tg-wo29">{{ en2bn($trialDate) }}</td>
                                    <td class="tg-wo29">{{ $note['case_short_decision'] }}</td>
                                </tr>
                            @empty
