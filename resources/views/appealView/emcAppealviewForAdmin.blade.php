    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title h2 font-weight-bolder">{{ $results['page_title'] }}</h3>
                    </div>
                    <div class="col-md-4">
        ...
        <div class="card-body">
            ...
            <div class="row" id="element-to-print">
                ...
                <div class="col-md-12 py-5">
                    ...
                    <br>
                    @if (!empty($results['victimCitizen']))
                        <table class="table table-striped border">
                            <thead>
                    ...
                    <table class="table table-striped border">
                        ...
                        <tbody>
                            @php $k = 1; @endphp
                            @foreach ($results['defaulterCitizen'] as $bibadi)
                                <tr>
                                    <td>{{ en2bn($k) }}.</td>
                    ...
                    <table class="table table-striped border">
                        ...
                        <tbody>
                            @php $k = 1; @endphp
                            @foreach ($results['witnessCitizen'] as $witness)
                                <tr>
                                    <td>{{ en2bn($k) }}.</td>
                    ...
                    @if (!empty($results['lawerCitizen']))
                        <table class="table table-striped border">
                            ...
                            <tbody>
                                <tr>
                                    <td>{{ en2bn('1') }}.</td>
                                    <td>{{ $results['lawerCitizen']['citizen_name'] ?? '-' }}</td>
                                    <td>{{ $results['lawerCitizen']['father'] ?? '-' }}</td>
                                    <td>{{ $results['lawerCitizen']['present_address'] ?? '-' }}</td>
                                </tr>
                    ...
                    @endif
                    <br>
                    @if(!empty($results['defaulerWithnessCitizen']))
                    <table class="table table-striped border">
                        <thead>
                        ...
                        <tbody>
                            @php $k = 1; @endphp
                            @foreach ($results['defaulerWithnessCitizen'] as $witness)
                                <tr>
                                    <td>{{ en2bn($k) }}.</td>
                                    <td>{{ $witness['citizen_name'] ?? '-' }}</td>
                                    <td>{{ $witness['father'] ?? '-' }}</td>
                    ...
                    @endif
                    @if(!empty($results['defaulerLawyerCitizen']))
                    <table class="table table-striped border">
                        <thead>
                        ...
                        <tbody>
                            @php $k = 1; @endphp
                            @foreach ($results['defaulerLawyerCitizen'] as $witness)
                                <tr>
                                    <td>{{ en2bn($k) }}.</td>
                                    <td>{{ $witness['citizen_name'] ?? '-' }}</td>
                                    <td>{{ $witness['father'] ?? '-' }}</td>
                                ...
                                <div class="form-group mb-2" id="deleteFile{{ $row['id'] }}">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <a href="<?=getEmcBaseUrl().'/'. $row['file_path'] . $row['file_name']?>" target="_blank"
