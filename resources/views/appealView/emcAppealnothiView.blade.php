                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <th width="100">
                                            <a href="{{ route('emc.show.appeal.case.orderSheetDetails', $appealId) }}" target="_blank"><button id="printReport" class="btn btn-primary btn-link"
                                                type="button">
                                                <i class="flaticon-eye icon-xl"></i>দেখুন
                                            </button></a>
                                        </th>
                                    </tr>
                                </tbody>
                                            ...
                                            @endphp
                                                 <tr>
                                                    <th  width="100" scope="col" class="align-middle">{{ en2bn(++$key)}} -
                                                        নম্বর : {{ $shortOrderTemplate['case_no'] }}</th>
                                                    <th scope="col" class="align-middle">
                                                        {{-- {{ en2bn(date_formater_helpers_make_bd($trialDate[0])) }} --}}
                                                    </th>
                                                    <th scope="col" class="align-middle">
                                                        {{ $shortOrderTemplate['template_name'] }}
                                                    </th>
                                                    <th width="100">
                                                        <a  href="{{ route('emc.show.appeal.case.shortOrderSheets', ['id'=>$shortOrderTemplate['id']]) }}" target="_blank">
                    ...
                    <div class="card">
                        <div class="card-header bg-info" id="headingThree4">
                            <div class="card-title collapsed text-white" data-toggle="collapse" data-target="#collapseThree4">
                                <i class="flaticon-attachment text-white"></i> নথি
                            </div>
                        </div>
                        <div id="collapseThree4" class="collapse" data-parent="#accordionExample4">
                            <div class="card-body">
                                <table class="table table-bordered table-condensed margin-0">
                                    ...
                                    ?>
                                        <tr>
                                            <th  width="100" scope="col" class="align-middle">{{ $nfiles['index'] }} - নম্বর : {{ $nfiles['case_no'] }}
                                            </th>
                                            <th scope="col" class="align-middle">
                                                {{ $trialDate[0] }}
                                            </th>
                                            ...
                                            <th width="100" class="align-middle">
                                                <a href="<?=getEmcBaseUrl().'/'.$nfiles['file_path'] . $nfiles['file_name']?>" target="_blank"
                                    ...
                                    <tbody>
                                        ...
                                        @else
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $citizenAttendance['designation'] }}
                                                </td>
                                                <td>
                                                    {{ $citizenAttendance['attendance_date'] }}
                                                </td>
                                                <td>
