        ...
        <div class="card-body">
            ...
            <div class="row" id="element-to-print">
                ...
                <div class="col-md-12 py-5">
                    <table class="table table-striped border">
                        ...
                        <tbody>
                            @php $k = 1; @endphp
                            @foreach ($appeal_all['applicantCitizen'] as $badi)
                                <tr>
                                    <td>{{ en2bn($k) }}.</td>
                    ...
                    <br>
                    @if (!empty($appeal_all['victimCitizen']))
                        <table class="table table-striped border">
                            <thead>
                            ...
                            <tbody>
                                @php $k = 1; @endphp
                                @foreach ($appeal_all['victimCitizen'] as $victim)
                                    <tr>
                                        <td>{{ en2bn($k) }}.</td>
                    ...
                    <table class="table table-striped border">
                        ...
                        <tbody>
                            @php $k = 1; @endphp
                            @foreach ($appeal_all['defaulterCitizen'] as $bibadi)
                                <tr>
                                    <td>{{ en2bn($k) }}.</td>
                    ...
                    <table class="table table-striped border">
                        ...
                        <tbody>
                            @php $k = 1; @endphp
                            @foreach ($appeal_all['witnessCitizen'] as $witness)
                                <tr>
                                    <td>{{ en2bn($k) }}.</td>
                        ...
                        <tbody>
                            <tr>
                                <td>বিগত ইং {{ en2bn($appeal['case_date']) }} তারিখ মোতাবেক বাংলা
                                    ...
                                    । {{ convert_div_id_to_name($appeal['division_id']) ?? '-' }} বিভাগের
                                    {{ convert_dis_id_to_name($appeal['district_id']) ?? '-' }} জেলার
                                    {{ convert_upa_id_to_name($appeal['upazila_id']) ?? '-' }} উপজেলায়।
                                </td>
                            </tr>
                ...
                @if ($appeal_all['guarantorCitizen'])
                    <div class="col-md-6">
                        <table class="table table-striped border">
                            <thead>
            ...
            <table class="table table-striped border">
                ...
                <tbody>
                    <tr>
                        <td>
                            @forelse ($appeal_all['attachmentList'] as $key => $row)
