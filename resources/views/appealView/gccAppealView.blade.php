         ...
         <table>
            ...
            @if ($roleID == 5 || $roleID == 7 || $roleID == 8)
                <div class="card-toolbar">
                    <a href="{{ route('case.edit', $data['appeal']->id) }}" class="btn btn-sm btn-primary font-weight-bolder">
                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-striped border">
                        ...
                        <tbody>
                            ...
                            @php $k = 1; @endphp
                            @foreach ($data['defaulterCitizen'] as $badi)
                                <tr style="text-align:center">
                                    <td>{{ en2bn($k) }}.</td>
                                    <td>{{ $badi['citizen_name'] ?? '-' }}</td>
                                    <td>{{ $badi['father'] ?? '-' }}</td>
                                    <td>{{ $badi['present_address'] ?? '-' }}</td>
                                    <td>{{ $badi['permanent_address'] ?? '-' }}</td>
                                </tr>
                                @php $k++; @endphp
                            @endforeach
                                        ...
                                        <div class="form-group mb-2" id="deleteFile{{ $row['id'] }}">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <button class="btn bg-success-o-75" type="button">
                                                        {{ en2bn(++$key) . ' - নম্বর :' }}
                                                    </button>
                                                </div>
