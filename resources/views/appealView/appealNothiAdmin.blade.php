        ...
        <div class="card-header flex-wrap py-5">
            <div class="container">
                <div class="row">
                    ...
                    <a href="{{ route('messages_group') }}?c={{ $appeal->id }}" class="btn btn-success float-right">বার্তা</a>
                        @endif
                </div> --}}
                </div>
            </div>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <th width="100">
                                            <a href="{{ route('gcc.appeal.order.sheet', encrypt($caseInfo[0]['id'])) }}" target="_blank"><button id="printReport" class="btn btn-success btn-link"
                                                type="button">
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                         <tr>
                                            ...
                                            <th width="100">
                                                <a  href="{{ route('gcc.appeal.short.order.sheet', ['id'=>$shortOrderTemplate['id']]) }}" target="_blank">
                                                    <span class="btn btn-success btn-link"
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <th width="100" class="align-middle">
                                            <a href="<?=getGccBaseUrl().'/'.$nfiles['file_path'] . $nfiles['file_name']?>" target="_blank"
