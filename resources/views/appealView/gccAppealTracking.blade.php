        ...
        <div class="card-header flex-wrap py-5">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        {{-- @dd($data['appeal']['appeal_status']) --}}
                        @if ($data['appeal']['appeal_status'] == 'SEND_TO_EM' || $data['appeal']['appeal_status'] == 'SEND_TO_ADM')
            ...
            <div class="row" id="element-to-print">
                    ...
                    <table class="tg">
                        <thead>
                            <tr>
                                ...
                                <th class="tg-wo29">{{ appeal_status_bng($data['appeal']['appeal_status']) }}</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td class="tg-5kbr">মামলা নম্বর</td>
                                <td class="tg-wo29">{{ en2bn($data['appeal']['case_no']) }}</td>
                            </tr>
                            <tr>
                                <td class="tg-5kbr">আবেদনকারীর নাম</td>
                                {{-- @dd($data['appeal']) --}}
                                <td class="tg-wo29">{{ $data['applicant_name'] ?? '' }}</td>
                            </tr>
                            <tr>
                                <td class="tg-5kbr">আবেদনের তারিখ</td>
                                <td class="tg-wo29">{{ en2bn($data['appeal']['case_date']) }}</td>
                            </tr>
                            <tr>
                                <td class="tg-5kbr">আবেদনকারীর ধরন</td>
                                <td class="tg-wo29">{{ $data['applicant_type'] ?? '' }}</td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="col-md-8 mx-auto" style="margin-top: 20px; text-align:center">
                    ...
                    <table class="tg2">
                        ...
                        <tbody>
                            @forelse ($data['shortOrderTemplateList'] as $key => $shortOrderTemplate)
                                {{-- @dd($shortOrderTemplate['conduct_date']) --}}
                                {{-- @dd($data['shortOrderTemplateList']) --}}
                                @php
