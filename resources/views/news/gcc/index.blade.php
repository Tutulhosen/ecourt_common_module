...
<div class="card card-custom" style="margin-bottom: 20px">
   <div class="card-header flex-wrap py-5">
      ...
      <div class="card-toolbar">
         <a href="{{ route('gcc.news.create') }}" class="btn btn-sm btn-success font-weight-bolder">
                              ...
                              <tbody class=" text-center">
                                 @foreach($short_news as $key => $row)
                                       ...
                                       <tr class="text-center">
                                          ...
                                          @endif
                                          <td width="300">
                                             <a href="{{url('gcc/news/edit/'.$row->id)}}"style="color: white !important;">
                                                <button type="button" class="btn-sm btn btn-success">সম্পাদনা</button>
                                             </a>
                                                @if($row->status==1)
                                                   <a href="{{url('gcc/news/status/0/'.$row->id)}}"style="color: white !important;">
                                                      <button type="button" class="btn-sm btn btn-warning">অপসারণ</button>
                                                   </a>
                                                @elseif($row->status==0)
                                                   <a href="{{url('gcc/news/status/1/'.$row->id)}}"style="color: white !important;">
                                       ...
                                       <tr class="text-center">
                                          ...
                                          <td width="300">
                                             <a href="{{url('gcc/news/edit/'.$row->id)}}"style="color: white !important;">
                                                ...
                                                @endif
                                             <a href="{{url('gcc/news/delete/'.$row->id)}}" style="color: white !important;"><button type="button" class="btn-sm btn btn-danger">মুছে ফেলুন</button>
                                             </a>
                                          </td>
