...
@section('landing')
    ...
    @else
        ...
        <div  style="background-image: url('{{ asset('images/bg.jpg') }}'); background-size: cover; background-position: center; background-repeat: no-repeat; padding: 50px; border-radius: 10px;">
            <div class="row">
                ...
                <div class="col-md-6 shadow-sm p-3 mb-5 bg-white rounded mt-3">
                    ...
                    <form action="javascript:void(0)" class="form fv-plugins-bootstrap fv-plugins-framework"
                        ...
                        <div class="form-group fv-plugins-icon-container has-success">
                            ...
                            <label class="font-size-h6 font-weight-bolder text-dark">মোবাইল/ইমেইল</label>
                            ...
                            {{-- <p class="h4 pt-5 text-dark">ইকোর্ট সিস্টেমে একাউন্ট নেই? <a href="">রেজিস্ট্রেশন করুন </a></p> --}}
                        </div>
                    </form>
                </div>
                <div class="col-md-3"></div>
