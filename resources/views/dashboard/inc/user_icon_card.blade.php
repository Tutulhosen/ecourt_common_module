...
<div id="general_case" class="row general_case">
    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
        <a
            href="{{ Auth::user()->citizen_type_id == 1 ? route('emc.citizen.appeal.all_case') : route('gcc.pp.citizen.appeal.all_case') }}">
    ...
    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
        <a
            href="{{ Auth::user()->citizen_type_id == 1 ? route('emc.citizen.appeal.running_case') : route('gcc.pp.citizen.appeal.running_case') }}">
    ...
    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
        <a
            href="{{ Auth::user()->citizen_type_id == 1 ? route('emc.citizen.appeal.pending_case') : route('gcc.pp.citizen.appeal.pending_case') }}">
    ...
    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
        <a href="{{ Auth::user()->citizen_type_id == 1 ? route('emc.citizen.appeal.complete_case') : route('gcc.pp.citizen.appeal.complete_case') }}">
            <div class="card card-custom bg-success cardCustomBG bg-hover-state-success card-stretch gutter-b">
                <div class="card-body" style="">
                    <div class="align-items-center justify-content-between card-spacer flex-grow-1">
                        <span class="symbol symbol-50 symbol-light-success  mr-2">
...
<div id="appeal_case" class="row appeal_case" style="display: none;">
    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
        <a
            href="{{route('gcc.pp.citizen.case.for.appeal.all_case') }}">
            <div class="card card-custom bg-danger cardCustomBG bg-hover-state-danger card-stretch gutter-b">
                <div class="card-body" style="">
                    <div class="align-items-center justify-content-between card-spacer flex-grow-1">
                        <span class="symbol symbol-50 symbol-light-danger  mr-2">
    ...
    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
        <a
            href="{{route('gcc.pp.citizen.case.for.appeal.running_case') }}">
            <div class="card card-custom bg-success cardCustomBG bg-hover-state-success card-stretch gutter-b">
                <div class="card-body" style="">
                    <div class="align-items-center justify-content-between card-spacer flex-grow-1">
                        <span class="symbol symbol-50 symbol-light-success  mr-2">
    ...
    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
        <a
            href="{{route('gcc.pp.citizen.case.for.appeal.pending_case') }}">
            <div class="card card-custom bg-primary cardCustomBG bg-hover-state-primary card-stretch gutter-b">
                <div class="card-body" style="">
                    <div class="align-items-center justify-content-between card-spacer flex-grow-1">
                        <span class="symbol symbol-50 symbol-light-primary  mr-2">
    ...
    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
        <a href="{{route('gcc.pp.citizen.case.for.appeal.complete_case') }}">
            <div class="card card-custom bg-success cardCustomBG bg-hover-state-success card-stretch gutter-b">
                <div class="card-body" style="">
                    <div class="align-items-center justify-content-between card-spacer flex-grow-1">
                        <span class="symbol symbol-50 symbol-light-success  mr-2">
