<div id="gccDashboard" class="citizen_dashboard">
    <h4 class="dashboard_title">জেনারেল সার্টিফিকেট কোর্ট ড্যাশবোর্ড</h4>
    @include('dashboard.inc.user_icon_card_gcc_citizen')
