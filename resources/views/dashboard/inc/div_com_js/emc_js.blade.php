<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        emc_case_pie_chart();
        // District Dropdown
        jQuery('select[name="em_district"]').on('change', function() {
            var dataID = jQuery(this).val();
            jQuery("#em_upazila_id").after('<div class="loadersmall"></div>');
            ...
            jQuery.ajax({
                ...
                success: function(data) {
                    jQuery('select[name="em_upazila"]').html(
                        '<div class="loadersmall"></div>');
   
                    jQuery('select[name="em_upazila"]').html(
                        '<option value="">-- নির্বাচন করুন --</option>');
                    jQuery.each(data, function(key, value) {
                        jQuery('select[name="em_upazila"]').append('<option value="' +
                            key + '">' + value + '</option>');
                    });
    ...
    function crpc_statistic() {
        console.log('submitted! come hreer emc');
        // Variable
        let division = $("#em_division_id").val();
        let district = $("#em_district_id").val();
        let upazila = $("#em_upazila_id").val();
        let dateFrom = $("#em_date_from").val();
        let dateTo = $("#em_date_to").val();
        ...
        $.ajax({
            ...
            success: function(response) {
                console.log('come emc ero', response);
                if (response) {
