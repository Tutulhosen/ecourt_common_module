...
@section('content')
    ...
    <div class="card">
        <div class="p-5 m-5">
            ...
            <h3 class="text-center">সাপোর্ট সংক্রান্ত সেবা পেতে কল করুন (কর্ম দিবস সকাল ১০ টা থেকে সন্ধ্যা ৬ টা পর্যন্ত)- 01550703084
                {{-- <spna id="input_support_email">{{  isset(globalUserInfo()->email) ? globalUserInfo()->email : old('support_email') }}</spna> ইমেইল এ প্রদান করা হবে --}} </h3>
            <form action="{{ route('support.form.post.citizen') }}" method="post"  enctype="multipart/form-data">
                ...
                <button type="submit" class="btn btn-success px-5 me-5">প্রেরণ</button>
            </form>

        </div>
    </div>

    @include('support.gcc._support_create_Js')
